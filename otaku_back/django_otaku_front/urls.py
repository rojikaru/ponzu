...
urlpatterns = [
    ...
    path('anime/<str:pk>/', AnimeView.as_view(), name='anime_detail'),
    path('anime/<str:pk>/delete/', anime_delete, name='anime_delete'),
    path('anime/<str:pk>/edit/', AnimeEditView.as_view(), name='anime_edit'),
